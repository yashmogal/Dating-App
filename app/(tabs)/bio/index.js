...
const index = () => {
  ...
  const fetchUserDescription = async () => {
    try {
      const response = await axios.get(`http://192.168.0.106:3000/users/${userId}`);
  ...
  const updateUserDescription = async () => {
    try {
      const response = await axios.put(
        `http://192.168.0.106:3000/users/${userId}/description`,
        {
  ...
  const addLookingFor = async (lookingFor) => {
    try {
      const response = await axios.put(
        `http://192.168.0.106:3000/users/${userId}/looking-for`,
        {
  ...
  const removeLookingFor = async (lookingFor) => {
    try {
      const response = await axios.put(
        `http://192.168.0.106:3000/users/${userId}/looking-for/remove`,
        {
          lookingFor: lookingFor,
        }
      );
  ...
  const addTurnOn = async (turnOn) => {
    try {
      const response = await axios.put(
        `http://192.168.0.106:3000/users/${userId}/turn-ons/add`,
        {
          turnOn: turnOn,
        }
      );
  ...
  const removeTurnOn = async (turnOn) => {
    try {
      const response = await axios.put(
        `http://192.168.0.106:3000/users/${userId}/turn-ons/remove`,
        {
          turnOn: turnOn,
        }
      );
  ...
  const handleAddImage = async () =>{
      try{
        const response = await axios.post(`http://192.168.0.106:3000/users/${userId}/profile-images`,{
            imageUrl:imageUrl
        });
